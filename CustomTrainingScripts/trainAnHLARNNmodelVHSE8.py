...
@see RNNBluePrint.py  
@note: The model uses VHSE8 encoding to encode the provided amino acids.
"""
# load the modules:
...
model=buildHlaCNN_RNNModel(inputSize=37,numberOfTokens=21,
                           embDim=8,embWeights=VHSE,trainEmb=False) # use VHSE for encoding and prevent weight updates
